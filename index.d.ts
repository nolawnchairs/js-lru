 ...
 */
export declare class LRUMap<K extends ScalarType, V> {
	 ...
	 * @memberof LRUMap
	 */
	static unbounded<K extends ScalarType, V>(entries?: Iterable<[
		K,
		V
	]>): LRUMap<K, V>;
	/**
...
export declare type ScalarType = string | number | symbol;
